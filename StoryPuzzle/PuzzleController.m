...
- (int)pointsForPiece:(PieceView*)piece {
    int points = 1000 + (piece.moves ? 1000/piece.moves : 0) + 1000/(piece.rotations+1) + NumberSquare*1000/(int)(elapsedTime+10);
...
- (void)createPieces {
    ...
    NSMutableArray<PieceView *> *arrayPieces = [[NSMutableArray alloc] initWithCapacity:NumberSquare];
        ...
        for (int i=0;i<pieceNumber;i++){
            ...
            for (int j=0;j<pieceNumber;j++){
                ...
                if (i>0) {
                    ...
                    int e = [arrayPieces[l].edges[1] intValue];
